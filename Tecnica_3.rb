...
faturamento_acima_de_zero = dados.map { |dia| dia['valor'] }.reject { |valor| valor == 0 }
...
dias_acima_da_media = faturamento_acima_de_zero.count { |valor| valor > media_faturamento }

puts "Menor valor de faturamento: R$ #{'%.2f' % menor_faturamento}"
puts "Maior valor de faturamento: R$ #{'%.2f' % maior_faturamento}"
